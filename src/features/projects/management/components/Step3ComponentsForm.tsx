      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 bg-[#0A3C2F] hover:bg-[#072F25] text-white text-xs font-semibold px-3.5 py-2 rounded-xl transition-colors cursor-pointer shadow-2xs"
          >
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 flex-1">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#0A3C2F] text-white text-[10px] font-semibold">
                    {compIdx + 1}
                  </span>
                  <input
                    type="text"
                    ...
                    className="flex-1 rounded-xl bg-white border border-slate-300 px-3.5 py-2 text-xs font-semibold text-slate-900 focus:border-[#0A3C2F] outline-none"
                  />
                </div>
              ...
              <div className="pl-8 space-y-2 pt-1 border-l-2 border-emerald-200 ml-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[11px] font-semibold text-[#0A3C2F] hover:underline flex items-center gap-1 cursor-pointer"
                  >
