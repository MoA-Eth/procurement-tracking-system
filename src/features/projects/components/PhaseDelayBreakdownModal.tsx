  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-3 sm:p-4 overflow-y-auto animate-in fade-in duration-150">
      <div className="w-full max-w-4xl bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden my-6 animate-in zoom-in-95 flex flex-col max-h-[90vh]">
        {/* Modal Header */}
        <div className="px-6 py-5 bg-[#0A3C2F] text-white flex items-start justify-between gap-4 shrink-0">
          <div className="space-y-1">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-rose-500 text-white shadow-2xs inline-flex items-center gap-1">
                <AlertTriangle className="w-3 h-3" />
                {displayTotalDelay} Days Delayed
              </span>
              {data.category && (
                <span className="px-2 py-0.5 rounded text-[11px] font-semibold bg-white/15 text-emerald-100">
                  {data.category}
                </span>
              )}
              {data.method && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="p-4 rounded-xl bg-rose-50/70 border border-rose-200 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-semibold text-rose-950 mt-0.5">
            ...
            <div className="p-4 rounded-xl bg-amber-50/70 border border-amber-200 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-amber-950 mt-1 line-clamp-1">
                  ...
                  {phaseItems.map((phase, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 px-3 text-center font-semibold text-slate-800 tabular-nums">
                        ...
                        <td className="py-3 px-3 text-center whitespace-nowrap">
                          {isNA ? (
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-rose-100 text-rose-800 border border-rose-200 shadow-2xs">
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between gap-4 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-full border border-slate-200 bg-white hover:bg-slate-100 text-slate-700 text-xs font-semibold transition-colors cursor-pointer"
            >
              Close
            </button>
            ...
            {data.activityHref && (
              <Link
                ...
                onClick={onClose}
                className="px-4 py-2 rounded-full bg-[#0A3C2F] hover:bg-[#083025] text-white text-xs font-semibold transition-all shadow-xs inline-flex items-center gap-1.5 cursor-pointer"
              >
