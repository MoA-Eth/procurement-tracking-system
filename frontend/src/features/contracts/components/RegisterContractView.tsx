          ...
          >
            ...
            <div className="mt-5 border-t border-slate-200 pt-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  className="inline-flex h-8 items-center gap-1.5 rounded-md border border-emerald-200 bg-white px-3 text-[11px] font-semibold text-[#0A3C2F] hover:bg-emerald-50"
        ...
        <div className="mx-auto flex max-w-[100rem] items-center justify-between gap-3">
          <Link
            ...
            href={
              fromTracker
                ? selectedContext
                  ? `/workspace/activity-tracker?project=${encodeURIComponent(
...
function CalculatedValue({
  ...
  return (
    <div className={emphasized ? "bg-emerald-50 p-3" : "bg-slate-50 p-3"}>
