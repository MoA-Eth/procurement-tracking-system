...
export function ExcelImportModal({
  ...
  async function handleFileSelect(selectedFile: File) {
    ...
    try {
      const result = await parseActivitiesFromExcel(selectedFile);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300">
                {planName
                  ? `Import into plan: ${planName}`
                  : projectCode
                    ? `Project Code: ${projectCode}`
                    : "Upload Excel or CSV file to bulk import activities"}
              </p>
            </div>
          </div>
          <button
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <button
                  ...
                  onClick={downloadActivityExcelTemplate}
                  type="button"
                >
