      ...
      <div className="relative flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl border border-slate-200">
            ...
            <div className="space-y-5">
              <div
                className={`relative flex flex-col items-center justify-center rounded-2xl border-2 border-dashed p-8 text-center transition cursor-pointer ${
                  isDragOver
                    ? "border-[#006837] bg-emerald-50 scale-[0.99]"
                    : "border-slate-300 bg-slate-50/70 hover:border-[#006837] hover:bg-emerald-50/50"
                }`}
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white">
                    {displayedRows.map((row, i) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-center">
                          <span className="inline-flex items-center rounded-md bg-slate-100 px-2 py-0.5 text-[10px] font-medium text-slate-700 border border-slate-200">
                            {row.status}
                          </span>
                        </td>
        ...
        <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50 px-6 py-4">
          ...
          {parseResult && parseResult.validCount > 0 && (
            <button
              className="inline-flex items-center gap-2 rounded-xl bg-[#006837] px-5 py-2.5 text-xs font-semibold text-white shadow-xs hover:bg-[#00552c] transition cursor-pointer disabled:opacity-50"
              disabled={isUploading}
