        ...
        <div className="flex items-start justify-between border-b border-slate-100 bg-gradient-to-r from-emerald-900 via-teal-900 to-[#0A3C2F] px-6 py-5 text-white">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 rounded-full bg-emerald-400/20 px-2.5 py-0.5 text-[11px] font-bold text-emerald-200 border border-emerald-300/30">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="rounded-xl border border-emerald-200 bg-emerald-50/60 p-4 space-y-2">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="rounded bg-emerald-200/80 px-2 py-0.5 font-bold text-emerald-900 text-[10px]">
                {parentPlan.status}
              </span>
            </div>
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="inline-flex items-center gap-2 rounded-xl bg-[#0A3C2F] px-5 py-2.5 text-xs font-bold text-white shadow-xs hover:bg-[#072b22] focus:ring-2 focus:ring-emerald-500/20 disabled:opacity-50 transition cursor-pointer"
            >
              {isSubmitting ? (
